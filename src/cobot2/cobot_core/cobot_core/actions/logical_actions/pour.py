...
class Pour(BaseAction):
    ...
    def execute(self):  
        ...
        if 85 <= current_joint[2] <= 95 and 85 <= current_joint[4] <= 95 :
            ...
            if not self.manager.perform('movel', pos=[312,-198,187,vertical_current_pos[3],vertical_current_pos[4],vertical_current_pos[5]],vel=100,acc=100,mode='abs'): return False
        ...
        # 붓는 위치로 이동
            ...
            if not self.manager.perform('movel', pos=[312,-198,187,horizontal_current_pos[3],horizontal_current_pos[4],horizontal_current_pos[5]],vel=100,acc=100): return False
